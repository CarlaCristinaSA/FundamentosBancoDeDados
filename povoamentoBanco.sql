...
-- Povoamento Tabela ASSISTIDA_REDE_APOIO
INSERT INTO REDE_DE_APOIO (Email, Nome) VALUES
...
INSERT INTO ASSISTIDA_REDE_APOIO (id_assistida, email_rede) VALUES 
(1, 'deam.central@policia.gov.br'),
(2, 'cras.centro@pref.gov.br'),
(3, 'hospital.mulher@saude.gov.br'),
(4, 'patrulha.mp@pm.gov.br'),
(5, 'defensoria.mulher@dp.gov.br'),
(6, 'cras.bairro1@pref.gov.br'),
(7, 'deam.norte@policia.gov.br'),
(8, 'ong.mulheres@ong.org'),
(9, 'upa.sul@saude.gov.br'),
(10, 'caps.ad@saude.gov.br'),
(11, 'cras.rural1@pref.gov.br'),
(12, 'conselho.tutelar1@pref.gov.br'),
(13, 'sine@trabalho.gov.br'),
(14, 'cras.bairro3@pref.gov.br'),
(15, 'hospital.trauma@saude.gov.br'),
(16, 'creas.regional1@pref.gov.br'),
(17, 'deam.leste@policia.gov.br'),
(18, 'ong.paz@ong.org'),
(19, 'abrigo.municipal@pref.gov.br'),
(20, 'tj.juizado1@tj.gov.br'),
(21, 'mp.violencia@mp.gov.br'),
(22, 'cras.bairro5@pref.gov.br'),
(23, 'oab.mulher@oab.org'),
(24, 'universidade.psico@edu.br'),
(25, 'disque180@gov.br'),
(26, 'cras.bairro6@pref.gov.br'),
(27, 'deam.sul@policia.gov.br'),
(28, 'habitacao@pref.gov.br'),
(29, 'cras.bairro8@pref.gov.br'),
(30, 'policia.civil@pc.gov.br'),
(31, 'ong.vida@ong.org'),
(32, 'cras.bairro2@pref.gov.br'),
(33, 'hospital.geral@saude.gov.br'),
(34, 'creas.regional3@pref.gov.br'),
(35, 'caps.3@saude.gov.br'),
(36, 'cras.rural2@pref.gov.br'),
(37, 'ong.frida@ong.org'),
(38, 'defensoria.familia@dp.gov.br'),
(39, 'tj.familia1@tj.gov.br'),
(40, 'cras.bairro10@pref.gov.br'),
(41, 'deam.oeste@policia.gov.br'),
(42, 'abrigo.esperanca@ong.org'),
(43, 'coord.habitacao@prefeitura.gov.br'),
(44, 'bancodeempregos@sine.gov.br'),
(45, 'universidade.direito@edu.br'),
(46, 'cras.bairro4@pref.gov.br'),
(47, 'ong.maria@ong.org'),
(48, 'policia.militar@pm.gov.br'),
(49, 'iml@pericia.gov.br'),
(50, 'cras.bairro6@pref.gov.br'),
(51, 'deam.central@policia.gov.br'),
(52, 'cras.centro@pref.gov.br'),
(53, 'hospital.mulher@saude.gov.br'),
(54, 'caps.infantil@saude.gov.br'),
(55, 'cras.bairro7@pref.gov.br'),
(56, 'creas.regional2@pref.gov.br'),
(57, 'ong.clara@ong.org'),
(58, 'conselho.tutelar2@pref.gov.br'),
(59, 'assistencia@pref.gov.br'),
(60, 'cras.bairro9@pref.gov.br'),
(61, 'ong.igualdade@ong.org'),
(62, 'deam.norte@policia.gov.br'),
(63, 'tj.juizado2@tj.gov.br'),
(64, 'abrigo.luz@ong.org'),
(65, 'igreja.social@email.com'),
(66, 'cras.rural1@pref.gov.br'),
(67, 'upa.norte@saude.gov.br'),
(68, 'ong.respeito@ong.org'),
(69, 'defensoria.mulher@dp.gov.br'),
(70, 'educacao@pref.gov.br'),
(71, 'cras.bairro3@pref.gov.br'),
(72, 'disque180@gov.br'),
(73, 'patrulha.mp@pm.gov.br'),
(74, 'cras.bairro5@pref.gov.br'),
(75, 'hospital.trauma@saude.gov.br'),
(76, 'creas.regional4@pref.gov.br'),
(77, 'ong.familia@ong.org'),
(78, 'conselho.tutelar3@pref.gov.br'),
(79, 'cras.bairro1@pref.gov.br'),
(80, 'deam.sul@policia.gov.br');
...
COMPORTAMENTO_VIOLENCIA
INSERT INTO COMPORTAMENTO_VIOLENCIA (id_violencia, id_caso, id_assistida, descricao_comportamento)
VALUES 
    (1, 1, 1, 'CIUMES EXCESSIVO'),
    (2, 2, 2, 'CONTROLE DE HORARIOS'),
    (3, 3, 3, 'ISOLAMENTO SOCIAL'),
    (4, 4, 4, 'HUMILHACAO PUBLICA'),
    (5, 5, 5, 'QUEBRA DE OBJETOS'),
    (6, 6, 6, 'PERSEGUICAO'),
    (7, 7, 7, 'MONITORAMENTO DE CELULAR'),
    (8, 8, 8, 'CONTROLE FINANCEIRO'),
    (9, 9, 9, 'NEGACAO DE MEDICAMENTOS'),
    (10, 10, 10, 'MANIPULACAO EMOCIONAL'),
    (11, 11, 11, 'CULPABILIZACAO DA VITIMA'),
    (12, 12, 12, 'MAUS TRATOS A ANIMAIS'),
    (13, 13, 13, 'PROIBICAO DE TRABALHAR'),
    (14, 14, 14, 'DIFAMACAO'),
    (15, 15, 15, 'RETENCAO DE DOCUMENTOS'),
    (16, 16, 16, 'EXIBICAO DE ARMA'),
    (17, 17, 17, 'GRITOS FREQUENTES'),
    (18, 18, 18, 'MENSAGENS EXCESSIVAS'),
    (19, 19, 19, 'AMEACA DE SUICIDIO'),
    (20, 20, 20, 'PERTURBACAO NO TRABALHO'),
    (21, 21, 21, 'CIUMES DOENTIO'),
    (22, 22, 22, 'IMPEDIR CONTATO FAMILIAR'),
    (23, 23, 23, 'CRITICAS A APARENCIA'),
    (24, 24, 24, 'EXPLOSOES DE RAIVA'),
    (25, 25, 25, 'USO DOS FILHOS'),
    (26, 26, 26, 'EXIGENCIA DE SENHAS'),
    (27, 27, 27, 'CONTROLE DE GASTOS'),
    (28, 28, 28, 'AMEACAS VELADAS'),
    (29, 29, 29, 'JOGOS MENTAIS'),
    (30, 30, 30, 'SILENCIO PUNITIVO'),
    (31, 31, 31, 'CIUMES EXCESSIVO'),
    (32, 32, 32, 'CONTROLE DE ROUPAS'),
    (33, 33, 33, 'ISOLAMENTO'),
    (34, 34, 34, 'HUMILHACAO'),
    (35, 35, 35, 'DESTRUICAO DE BENS'),
    (36, 36, 36, 'PERSEGUICAO'),
    (37, 37, 37, 'RASTREADOR NO CELULAR'),
    (38, 38, 38, 'CHANTAGEM'),
    (39, 39, 39, 'NEGLIGENCIA'),
    (40, 40, 40, 'MANIPULACAO'),
    (41, 41, 41, 'VITIMIZACAO'),
    (42, 42, 42, 'CRUELDADE'),
    (43, 43, 43, 'SABOTAGEM NO TRABALHO'),
    (44, 44, 44, 'CALUNIA'),
    (45, 45, 45, 'OCULTACAO DE BENS'),
    (46, 46, 46, 'INTIMIDACAO'),
    (47, 47, 47, 'AGRESSIVIDADE VERBAL'),
    (48, 48, 48, 'LIGACOES OBSESSIVAS'),
    (49, 49, 49, 'AUTO MUTILACAO (AMEACA)'),
    (50, 50, 50, 'ESCANDALO PUBLICO'),
    (51, 51, 51, 'CIUMES'),
    (52, 52, 52, 'CONTROLE'),
    (53, 53, 53, 'ISOLAMENTO'),
    (54, 54, 54, 'HUMILHACAO'),
    (55, 55, 55, 'DESTRUICAO'),
    (56, 56, 56, 'STALKING'),
    (57, 57, 57, 'MONITORAMENTO'),
    (58, 58, 58, 'CHANTAGEM FINANCEIRA'),
    (59, 59, 59, 'DESCUIDO PROPOSITAL'),
    (60, 60, 60, 'GASLIGHTING'),
    (61, 61, 61, 'CULPA'),
    (62, 62, 62, 'MAUS TRATOS PETS'),
    (63, 63, 63, 'SABOTAGEM'),
    (64, 64, 64, 'INJURIA'),
    (65, 65, 65, 'ROUBO DE DOCUMENTOS'),
    (66, 66, 66, 'COACAO'),
    (67, 67, 67, 'GRITARIA'),
    (68, 68, 68, 'ASSEDIO'),
    (69, 69, 69, 'DRAMA EXCESSIVO'),
    (70, 70, 70, 'INVASAO DE PRIVACIDADE'),
    (71, 71, 71, 'CIUMES'),
    (72, 72, 72, 'CONTROLE DE SAIDAS'),
    (73, 73, 73, 'ISOLAMENTO FAMILIAR'),
    (74, 74, 74, 'PIADAS OFENSIVAS'),
    (75, 75, 75, 'SOCOS NA PAREDE'),
    (76, 76, 76, 'VIGILANCIA'),
    (77, 77, 77, 'GRAVACAO DE CONVERSAS'),
    (78, 78, 78, 'NEGACAO DE DINHEIRO'),
    (79, 79, 79, 'ABANDONO'),
    (80, 80, 80, 'DISTORCAO DOS FATOS');

TIPO_VIOLENCIA_PREENCHIMENTO
INSERT INTO TIPO_VIOLENCIA_PREENCHIMENTO (id_preenchimento, tipo_violencia)
VALUES 
    (1, 'FISICA'),
    (2, 'PSICOLOGICA'),
    (3, 'SEXUAL'),
...
VALUES 
    ('deam.central@policia.gov.br', 'DELEGACIA DA MULHER CENTRAL'),
    ('deam.norte@policia.gov.br', 'DELEGACIA DA MULHER NORTE'),
    ('deam.sul@policia.gov.br', 'DELEGACIA DA MULHER SUL'),
    ('deam.leste@policia.gov.br', 'DELEGACIA DA MULHER LESTE'),
    ('deam.oeste@policia.gov.br', 'DELEGACIA DA MULHER OESTE'),
    ('cras.centro@pref.gov.br', 'CRAS CENTRO'),
    ('cras.bairro1@pref.gov.br', 'CRAS JARDIM AMERICA'),
    ('cras.bairro2@pref.gov.br', 'CRAS VILA NOVA'),
    ('cras.bairro3@pref.gov.br', 'CRAS BELA VISTA'),
    ('cras.bairro4@pref.gov.br', 'CRAS SANTO ANTONIO'),
    ('cras.bairro5@pref.gov.br', 'CRAS SAO JOSE'),
    ('cras.bairro6@pref.gov.br', 'CRAS SANTA MARIA'),
    ('cras.bairro7@pref.gov.br', 'CRAS PROGRESSO'),
    ('cras.bairro8@pref.gov.br', 'CRAS ESPERANCA'),
    ('cras.bairro9@pref.gov.br', 'CRAS LIBERDADE'),
    ('cras.bairro10@pref.gov.br', 'CRAS UNIAO'),
    ('cras.rural1@pref.gov.br', 'CRAS ZONA RURAL NORTE'),
    ('cras.rural2@pref.gov.br', 'CRAS ZONA RURAL SUL'),
    ('creas.regional1@pref.gov.br', 'CREAS REGIONAL 1'),
    ('creas.regional2@pref.gov.br', 'CREAS REGIONAL 2'),
    ('creas.regional3@pref.gov.br', 'CREAS REGIONAL 3'),
    ('creas.regional4@pref.gov.br', 'CREAS REGIONAL 4'),
    ('creas.regional5@pref.gov.br', 'CREAS REGIONAL 5'),
    ('hospital.geral@saude.gov.br', 'HOSPITAL GERAL'),
    ('hospital.trauma@saude.gov.br', 'HOSPITAL DE TRAUMA'),
    ('hospital.mulher@saude.gov.br', 'HOSPITAL DA MULHER'),
    ('upa.centro@saude.gov.br', 'UPA CENTRO'),
    ('upa.norte@saude.gov.br', 'UPA NORTE'),
    ('upa.sul@saude.gov.br', 'UPA SUL'),
    ('caps.ad@saude.gov.br', 'CAPS ALCOOL E DROGAS'),
    ('caps.infantil@saude.gov.br', 'CAPS INFANTIL'),
    ('caps.2@saude.gov.br', 'CAPS II'),
    ('caps.3@saude.gov.br', 'CAPS III'),
    ('defensoria.mulher@dp.gov.br', 'DEFENSORIA PUBLICA NUDEM'),
    ('defensoria.familia@dp.gov.br', 'DEFENSORIA PUBLICA FAMILIA'),
    ('mp.violencia@mp.gov.br', 'PROMOTORIA DE VIOLENCIA DOMESTICA'),
    ('mp.familia@mp.gov.br', 'PROMOTORIA DE FAMILIA'),
    ('tj.juizado1@tj.gov.br', '1 JUIZADO DE VIOLENCIA DOMESTICA'),
    ('tj.juizado2@tj.gov.br', '2 JUIZADO DE VIOLENCIA DOMESTICA'),
    ('tj.familia1@tj.gov.br', '1 VARA DE FAMILIA'),
    ('tj.familia2@tj.gov.br', '2 VARA DE FAMILIA'),
    ('conselho.tutelar1@pref.gov.br', 'CONSELHO TUTELAR I'),
    ('conselho.tutelar2@pref.gov.br', 'CONSELHO TUTELAR II'),
    ('conselho.tutelar3@pref.gov.br', 'CONSELHO TUTELAR III'),
    ('conselho.tutelar4@pref.gov.br', 'CONSELHO TUTELAR IV'),
    ('conselho.tutelar5@pref.gov.br', 'CONSELHO TUTELAR V'),
    ('abrigo.municipal@pref.gov.br', 'CASA ABRIGO MUNICIPAL'),
    ('abrigo.esperanca@ong.org', 'CASA DE PASSAGEM ESPERANCA'),
    ('abrigo.vida@ong.org', 'CASA VIDA NOVA'),
    ('abrigo.luz@ong.org', 'ABRIGO LUZ DO AMANHA'),
    ('ong.mulheres@ong.org', 'ONG MULHERES UNIDAS'),
    ('ong.familia@ong.org', 'ONG APOIO A FAMILIA'),
    ('ong.vida@ong.org', 'ONG VALORIZACAO DA VIDA'),
    ('ong.paz@ong.org', 'ONG PAZ NO LAR'),
    ('ong.respeito@ong.org', 'COLETIVO RESPEITO'),
    ('ong.igualdade@ong.org', 'INSTITUTO IGUALDADE'),
    ('ong.maria@ong.org', 'ASSOCIACAO MARIA BONITA'),
    ('ong.clara@ong.org', 'INSTITUTO CLARA ZETKIN'),
    ('ong.rosa@ong.org', 'COLETIVO ROSA LUXEMBURGO'),
    ('ong.frida@ong.org', 'CASA FRIDA KAHLO'),
    ('patrulha.mp@pm.gov.br', 'PATRULHA MARIA DA PENHA'),
    ('policia.militar@pm.gov.br', 'BATALHAO DE POLICIA MILITAR'),
    ('policia.civil@pc.gov.br', 'DEPARTAMENTO DE POLICIA CIVIL'),
    ('iml@pericia.gov.br', 'INSTITUTO MEDICO LEGAL'),
    ('sine@trabalho.gov.br', 'SINE AGENCIA DE EMPREGO'),
    ('oab.mulher@oab.org', 'COMISSAO DA MULHER OAB'),
    ('oab.humanos@oab.org', 'DIREITOS HUMANOS OAB'),
    ('universidade.psico@edu.br', 'CLINICA ESCOLA PSICOLOGIA'),
    ('universidade.direito@edu.br', 'NUCLEO DE PRATICA JURIDICA'),
    ('habitacao@pref.gov.br', 'SECRETARIA DE HABITACAO'),
    ('educacao@pref.gov.br', 'SECRETARIA DE EDUCACAO'),
    ('saude@pref.gov.br', 'SECRETARIA DE SAUDE'),
    ('assistencia@pref.gov.br', 'SECRETARIA DE ASSISTENCIA SOCIAL'),
    ('transporte@pref.gov.br', 'SECRETARIA DE TRANSPORTE'),
    ('seguranca@pref.gov.br', 'SECRETARIA DE SEGURANCA'),
    ('igreja.social@email.com', 'PASTORAL DA FAMILIA'),
    ('centro.espiritual@email.com', 'CENTRO DE APOIO ESPIRITUAL'),
    ('associacao.bairro@email.com', 'ASSOCIACAO DE MORADORES'),
    ('projeto.social@email.com', 'PROJETO SOCIAL COMUNITARIO'),
    ('disque180@gov.br', 'CENTRAL DE ATENDIMENTO A MULHER');
    ('coord.habitacao@prefeitura.gov.br', 'SECRETARIA DE HABITACAO - PROGRAMA ALUGUEL SOCIAL'),
    ('bancodeempregos@sine.gov.br', 'SINE - SISTEMA NACIONAL DE EMPREGO');
...
VALUES 
    -- Casos 1 a 20 (Documentos Iniciais e BOs)
    (1, 1, 'boletim_ocorrencia_001.pdf', 'application/pdf', '\x255044462d312e350a'),
    (2, 2, 'foto_lesao_braço.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (3, 3, 'medida_protetiva_urgente.pdf', 'application/pdf', '\x255044462d312e350a'),
    (4, 4, 'laudo_iml_preliminar.pdf', 'application/pdf', '\x255044462d312e350a'),
    (5, 5, 'print_whatsapp_ameacas.png', 'image/png', '\x89504e470d0a1a0a'),
    (6, 6, 'boletim_ocorrencia_002.pdf', 'application/pdf', '\x255044462d312e350a'),
    (7, 7, 'depoimento_testemunha.mp3', 'audio/mpeg', '\x49443303000000000f76'),
    (8, 8, 'foto_rosto_agressao.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (9, 9, 'decisao_judicial_guarda.pdf', 'application/pdf', '\x255044462d312e350a'),
    (10, 10, 'print_facebook_difamacao.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (11, 11, 'requerimento_divorcio.pdf', 'application/pdf', '\x255044462d312e350a'),
    (12, 12, 'comprovante_residencia_vitima.pdf', 'application/pdf', '\x255044462d312e350a'),
    (13, 13, 'audio_ameaca_gravado.wav', 'audio/wav', '\x52494646240800005741'),
    (14, 14, 'foto_objetos_quebrados.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (15, 15, 'boletim_ocorrencia_003.pdf', 'application/pdf', '\x255044462d312e350a'),
    (16, 16, 'relatorio_psicologico.pdf', 'application/pdf', '\x255044462d312e350a'),
    (17, 17, 'carta_pedido_ajuda.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (18, 18, 'boletim_ocorrencia_004.pdf', 'application/pdf', '\x255044462d312e350a'),
    (19, 19, 'laudo_medico_hospital.pdf', 'application/pdf', '\x255044462d312e350a'),
    (20, 20, 'print_email_ameaca.pdf', 'application/pdf', '\x255044462d312e350a'),

    -- Casos 21 a 40 (Evidências e Laudos)
    (21, 21, 'solicitacao_abrigo.pdf', 'application/pdf', '\x255044462d312e350a'),
    (22, 22, 'foto_hematomas.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (23, 23, 'boletim_ocorrencia_005.pdf', 'application/pdf', '\x255044462d312e350a'),
    (24, 24, 'video_agressao_camera_seguranca.mp4', 'video/mp4', '\x00000018667479706d70'),
    (25, 25, 'laudo_traumatologico.pdf', 'application/pdf', '\x255044462d312e350a'),
    (26, 26, 'declaracao_escolar_filhos.pdf', 'application/pdf', '\x255044462d312e350a'),
    (27, 27, 'foto_porta_arrombada.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (28, 28, 'relatorio_assistencia_social.pdf', 'application/pdf', '\x255044462d312e350a'),
    (29, 29, 'boletim_ocorrencia_006.pdf', 'application/pdf', '\x255044462d312e350a'),
    (30, 30, 'audio_discussao.mp3', 'audio/mpeg', '\x49443303000000000f76'),
    (31, 31, 'extrato_bancario_saques_indevidos.pdf', 'application/pdf', '\x255044462d312e350a'),
    (32, 32, 'foto_roupas_rasgadas.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (33, 33, 'pedido_medida_protetiva.pdf', 'application/pdf', '\x255044462d312e350a'),
    (34, 34, 'boletim_ocorrencia_007.pdf', 'application/pdf', '\x255044462d312e350a'),
    (35, 35, 'laudo_psiquiatrico_agressor.pdf', 'application/pdf', '\x255044462d312e350a'),
    (36, 36, 'print_instagram_stalking.png', 'image/png', '\x89504e470d0a1a0a'),
    (37, 37, 'termo_de_representacao.pdf', 'application/pdf', '\x255044462d312e350a'),
    (38, 38, 'comprovante_renda.pdf', 'application/pdf', '\x255044462d312e350a'),
    (39, 39, 'foto_lesao_perna.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (40, 40, 'boletim_ocorrencia_008.pdf', 'application/pdf', '\x255044462d312e350a'),

    -- Casos 41 a 60 (Processos e Decisões)
    (41, 41, 'intimacao_audiencia.pdf', 'application/pdf', '\x255044462d312e350a'),
    (42, 42, 'relatorio_visita_domiciliar.pdf', 'application/pdf', '\x255044462d312e350a'),
    (43, 43, 'print_ameaca_sms.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (44, 44, 'boletim_ocorrencia_009.pdf', 'application/pdf', '\x255044462d312e350a'),
    (45, 45, 'encaminhamento_psicologo.pdf', 'application/pdf', '\x255044462d312e350a'),
    (46, 46, 'foto_carro_danificado.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (47, 47, 'sentenca_condenatoria.pdf', 'application/pdf', '\x255044462d312e350a'),
    (48, 48, 'atestado_medico.pdf', 'application/pdf', '\x255044462d312e350a'),
    (49, 49, 'video_depoimento.mp4', 'video/mp4', '\x00000018667479706d70'),
    (50, 50, 'boletim_ocorrencia_010.pdf', 'application/pdf', '\x255044462d312e350a'),
    (51, 51, 'documento_identidade_vitima.pdf', 'application/pdf', '\x255044462d312e350a'),
    (52, 52, 'print_localizacao_gps.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (53, 53, 'laudo_corpo_delito.pdf', 'application/pdf', '\x255044462d312e350a'),
    (54, 54, 'pedido_alimentos_provisorios.pdf', 'application/pdf', '\x255044462d312e350a'),
    (55, 55, 'foto_cicatrizes.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (56, 56, 'boletim_ocorrencia_011.pdf', 'application/pdf', '\x255044462d312e350a'),
    (57, 57, 'relatorio_conselho_tutelar.pdf', 'application/pdf', '\x255044462d312e350a'),
    (58, 58, 'comprovante_matricula_escolar.pdf', 'application/pdf', '\x255044462d312e350a'),
    (59, 59, 'audio_pedido_socorro.wav', 'audio/wav', '\x52494646240800005741'),
    (60, 60, 'boletim_ocorrencia_012.pdf', 'application/pdf', '\x255044462d312e350a'),

    -- Casos 61 a 80 (Diversos)
    (61, 61, 'termo_declaracao.pdf', 'application/pdf', '\x255044462d312e350a'),
    (62, 62, 'foto_vidro_quebrado.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (63, 63, 'boletim_ocorrencia_013.pdf', 'application/pdf', '\x255044462d312e350a'),
    (64, 64, 'encaminhamento_imulher.pdf', 'application/pdf', '\x255044462d312e350a'),
    (65, 65, 'print_whatsapp_agressor.png', 'image/png', '\x89504e470d0a1a0a'),
    (66, 66, 'laudo_social.pdf', 'application/pdf', '\x255044462d312e350a'),
    (67, 67, 'foto_lesao_costas.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (68, 68, 'boletim_ocorrencia_014.pdf', 'application/pdf', '\x255044462d312e350a'),
    (69, 69, 'decisao_medida_protetiva.pdf', 'application/pdf', '\x255044462d312e350a'),
    (70, 70, 'audio_agressao_verbal.mp3', 'audio/mpeg', '\x49443303000000000f76'),
    (71, 71, 'relatorio_final_caso.pdf', 'application/pdf', '\x255044462d312e350a'),
    (72, 72, 'foto_rosto_inchado.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (73, 73, 'boletim_ocorrencia_015.pdf', 'application/pdf', '\x255044462d312e350a'),
    (74, 74, 'termo_retatacao.pdf', 'application/pdf', '\x255044462d312e350a'),
    (75, 75, 'laudo_pericial.pdf', 'application/pdf', '\x255044462d312e350a'),
    (76, 76, 'print_rede_social.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (77, 77, 'oficio_juizado.pdf', 'application/pdf', '\x255044462d312e350a'),
    (78, 78, 'boletim_ocorrencia_016.pdf', 'application/pdf', '\x255044462d312e350a'),
    (79, 79, 'foto_celular_quebrado.jpg', 'image/jpeg', '\xffd8ffe000104a464946'),
    (80, 80, 'arquivamento_processo.pdf', 'application/pdf', '\x255044462d312e350a');
